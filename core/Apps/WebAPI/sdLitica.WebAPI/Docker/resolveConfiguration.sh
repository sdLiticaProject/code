...
set | grep SDLitica | sed 's|\([A-Za-z]*\)=.*|\1|' | while read varName
do
...
cat /opt/sdlitica/sdlitica.WebApi/appsettings.json.template | envsubst > /opt/sdlitica/sdlitica.WebApi/appsettings.json
echo "===================================="
cat /opt/sdlitica/sdlitica.WebApi/appsettings.json
echo "===================================="
